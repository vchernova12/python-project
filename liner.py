...
Difference_constraint_BB1_BB2 = {"Billboard1": 1.0,
                                "Billboard2": -1.0,
                                "Billboard3": 0.0}

Difference_constraint_BB1_BB3 = {"Billboard1": -1.0,
                                "Billboard2": 0.0,
                                "Billboard3": 1.0}

Difference_constraint_BB2_BB3 = {"Billboard1": 0.0,
                                "Billboard2": -1.0,
                                "Billboard3": 1.0}
...
# Constraints: 
prob += pulp.lpSum([Difference_constraint_BB1_BB2[i] * ingredient_vars[i] for i in Billboards]) <= 2
prob += pulp.lpSum([Difference_constraint_BB1_BB3[i] * ingredient_vars[i] for i in Billboards]) <= 10
prob += pulp.lpSum([Difference_constraint_BB2_BB3[i] * ingredient_vars[i] for i in Billboards]) <= 12
