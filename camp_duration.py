...
def camp_duration(camp_begin, camp_end):
    try: 
        ...
        if check_valid_date(camp_begin, camp_end):
            print(check_valid_date(camp_begin, camp_end))
            ...
            print(camp_duration_one_month(camp_begin, camp_end))
        elif camp_end.month-camp_begin.month >= 1 and camp_end.year == camp_begin.year:
            camp_duration_one_year(camp_begin, camp_end)
            print(camp_duration_one_year(camp_begin, camp_end))
        elif camp_end.year > camp_begin.year:
            camp_duration_with_year_transition(camp_begin, camp_end)
            print(camp_duration_with_year_transition(camp_begin, camp_end))
        return duration, camp_days_in_month
    except ValueError:
...
if __name__ == "__main__":
    print(camp_duration('12/27/2019', '12/31/2019'))
